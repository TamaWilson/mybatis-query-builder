...
class NumericOperationsStrategyTest {

    private static NumericOperationsStrategy strategy;
    ...
    static void setUp() throws NoSuchFieldException {
        strategy = new NumericOperationsStrategy();
    ...
    @Test
     void shouldReturnStrategyType(){
        Assertions.assertThat(strategy.getStrategyType()).isEqualTo(PredicateStrategyType.NUMERIC_OPERATIONS);
    }
